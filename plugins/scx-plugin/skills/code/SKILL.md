...
> As you work, write periodic progress updates to `/tmp/scx-plugin/progress/progress_<unique_id>.md`. Include what phase you are on, what you have completed, and what remains.
