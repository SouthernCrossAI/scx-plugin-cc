...
_HAS_KEY = bool(os.environ.get("SCX_API_KEY") or os.environ.get("SCX_API_KEY"))
requires_key = pytest.mark.skipif(not _HAS_KEY, reason="no SCX API key in environment")
...
def _platform_models():
    ...
    req = urllib.request.Request(
        ...
        headers={"Authorization": f"Bearer {get_scx_key()}"},
    )
